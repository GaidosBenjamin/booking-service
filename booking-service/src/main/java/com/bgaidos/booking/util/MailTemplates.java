...
public final class MailTemplates {
    ...
    public static MailBody bookingConfirmation(
        UUID bookingId,
        BigDecimal total,
        String currency,
        ...
        var subject = "Booking Confirmed — " + brandName;
        ...
        var plain = """
            ...
            — %s
            """.formatted(bookingId, camperList, total.toPlainString(), currency, brandName);
        var html = """
            <!DOCTYPE html>
            <html lang="en">
                  ...
                  <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:8px;box-shadow:0 1px 3px rgba(16,24,40,0.08);">
                    ...
                    <tr><td style="padding:0 40px 24px;background-color:#f9fafb;border-radius:6px;">
                      <table width="100%%" cellpadding="6" cellspacing="0">
                        <tr><td style="color:#6b7280;font-size:13px;">Booking ID</td><td style="font-size:13px;font-family:monospace;color:#111827;">%s</td></tr>
                        <tr><td style="color:#6b7280;font-size:13px;">Campers</td><td style="font-size:13px;color:#111827;">%s</td></tr>
                        <tr><td style="color:#6b7280;font-size:13px;">Total</td><td style="font-size:15px;font-weight:700;color:#111827;">%s %s</td></tr>
                      </table>
                    </td></tr>
            ...
            """.formatted(escape(brandName), bookingId, escape(camperList),
                total.toPlainString(), currency.toUpperCase(), escape(brandName));
